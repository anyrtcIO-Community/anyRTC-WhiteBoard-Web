      ...
      <div class="ar-container is-vertical">
        <div class="ar-rtcp_control">
          ...
          <div class="ar-rtcp_control_right">
            <button type="error" @click="leaveBoard" class="signOut">退出</button>
          </div>
        </div>
        <!--  -->
        <h3>画板终端窗口</h3>
...
export default {
  data(){
    return{
      ...
      backgroundList: [//画板背景图，第一次初始化后生效（调用注销画板API后将会清空）
        ...
        // {
        //   board_background: 'http://oss.teameeting.cn/docs/140248771/20180929173501062526/document_20180929173501536430_28.jpg',
        //   board_number: 28
        // },
      ]
    }
  ...
  destroyed(){
    ...
    this.Board && ( this.Board.destoryBoard(), this.Board.leave(), this.Board = null);
  }
}
</script>
<style lang="scss">
